        ...
        while (running) {
            ...
            switch (choice) {
                    ...
                    while (updating) {
                        ...
                        switch (field) {
                            case 1:
                                ...
                                licenseToUpdate.setDriverName(scanner.nextLine());
                                break;
                            case 2:
                                System.out.print("Enter new address: ");
                                licenseToUpdate.setAddress(scanner.nextLine());
                                break;
                            case 3:
                                System.out.print("Enter new experience (novice/expert): ");
                                licenseToUpdate.setExperience(scanner.nextLine());
                                break;
                            case 4:
                                System.out.print("Enter new vehicle type (car/truck/motor bike): ");
                                licenseToUpdate.setVehicleType(scanner.nextLine());
                                break;
                            case 5:
                                System.out.print("Enter new vehicle brand: ");
                                licenseToUpdate.setVehicleBrand(scanner.nextLine());
                                break;
                            case 6:
                                System.out.print("Enter new manufacturing year: ");
                                try {
                                    licenseToUpdate.setManufacturingYear(Integer.parseInt(scanner.nextLine()));
                                } catch (NumberFormatException e) {
                            ...
                            case 7:
                                ...
                                try {
                                    licenseToUpdate.setIssuingYear(Integer.parseInt(scanner.nextLine()));
                                } catch (NumberFormatException e) {
                                    System.out.println("Invalid year. No change made.");
                                }
                                break;
                ...
                case 3:
                    ...
                    scanner.nextLine(); // consume newline
                    DriverLisence found = null;
                    switch (searchOption) {
                        case 1:
                            System.out.print("Enter driver ID: ");
                            int searchID = scanner.nextInt();
                            scanner.nextLine();
                            found = manager.searchLicense(searchID);
                            break;
                        case 2:
                            System.out.print("Enter driver name: ");
